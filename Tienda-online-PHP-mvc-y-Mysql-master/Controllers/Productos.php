...
class Productos extends Controller
{
    ...
    public function listar() //Lista los productos 
    {
    ...
    public function verGaleria($id_producto) //Observamos la galeria 
    {
        $result = array();
    ...
    public function eliminarImg() //Eliminacion de la imagen que tiene los productos 
    {
